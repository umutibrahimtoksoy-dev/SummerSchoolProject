    ...
    <form id="Form1" runat ="server" >
        ...
        <br />
         <div>
            ...
            <asp:TextBox ID="TxtNumara" runat="server" class="form-control" OnTextChanged="TxtNumara_TextChanged"></asp:TextBox>
        </div>
        <br />
         <div>
             <strong>
            ...
            <asp:TextBox ID="TxtFotograf" runat="server" class="form-control" OnTextChanged="TxtFotograf_TextChanged"></asp:TextBox>
        </div>
        <br />
         <div>
             <strong>
        ...
        <br>
        <asp:Button ID="Button1" runat="server" Text="Ekle" OnClick="Button1_Click" CssClass="btn btn-info" Width="100px"  Height="50px" />
    </form>
